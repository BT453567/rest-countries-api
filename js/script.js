...
optionItems.forEach(option => {
  option.addEventListener('click', () => {
    if (option.dataset.value === "") {
      triggerSpan.textContent = "Filter by Region"; // reset
...
darkModeButton.addEventListener('click', function() {
  ...
  const isDark = document.body.classList.toggle("dark-mode"); // true if added
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // when params are entered after page e.g. index.html?country=france
